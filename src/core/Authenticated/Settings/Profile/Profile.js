  ...
  render() {
    ...
    return (
      <ScreenContainer withPadding={false} grey>
        ...
        <Description>
          Currently in app edits to your account information can’t be made here,
          you’ll be taken to the FPF website to make these any changes by
          clikcing the blue external links below.
        </Description>
